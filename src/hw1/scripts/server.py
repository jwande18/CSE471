...
def ros_generate_maze(req):
    ...
    max_obstacles =  req.dimension * (req.dimension + 1) * 2
    ...
    global mazeInfo
    mazeInfo = my_maze.generate_maze(req.dimension, req.obstacles, req.seed)
...
def generate_maze(dimension, obstacles, seed):
...
def initialize_search_server():
    ...
    # Start the server.        
    subprocess.Popen("rosrun hw1 server.py", shell=True,
